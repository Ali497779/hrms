                                        ...
                                        <tr class="single-item">
                                            ...
                                            <td>
                                                <select class="form-select form-control max-select"
                                                    ...
                                                    <option value="indigo" data-bg="bg-indigo">Customs</option>
                                                    <option value="primary" data-bg="bg-primary" selected>Wholesale
                                                    </option>
                                                    <option value="danger" data-bg="bg-danger" selected>Low Budget
                                                    </option>
                                        ...
                                        <tr class="single-item">
                                            ...
                                            <td>
                                                <select class="form-select form-control max-select"
                                                    ...
                                                    <option value="teal" data-bg="bg-teal">Primary</option>
                                                    <option value="success" data-bg="bg-success">Updates</option>
                                                    <option value="warning" data-bg="bg-warning" selected>Personal
                                                    </option>
                                                    <option value="danger" data-bg="bg-danger" selected>Promotions
                                                    </option>
                                                    <option value="indigo" data-bg="bg-indigo">Customs</option>
                                        ...
                                        <tr class="single-item">
                                            ...
                                            <td>
                                                <select class="form-select form-control max-select"
                                                    ...
                                                    <option value="success" data-bg="bg-success" selected>Updates
                                                    </option>
                                                    <option value="warning" data-bg="bg-warning" selected>Personal
                                                    </option>
                                            ...
                                            <td>
                                                <select class="form-control" data-select2-selector="status">
                                                    ...
                                                    <option value="warning" data-bg="bg-warning" selected>Inactive
                                                    </option>
                                                    <option value="danger" data-bg="bg-danger">Declined</option>
                                                </select>
                                            </td>
